...
import {
  Search, Menu, X, Sun, Moon, Bell, LogIn,
...
export function Header() {
  ...
  const { user, appUser, isAdmin, isOwner, isLoggedIn } = useAuth();
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/" className="flex items-center gap-2 font-display">
              ...
              <span className={cn(
                ...
                scrolled ? 'text-surface-900 dark:text-white' : 'text-surface-900 dark:text-white'
              )}>
                ...
                <div className="relative">
                  ...
                  >
                    <Avatar
                      ...
                      name={appUser?.displayName || user?.displayName || 'User'}
                      size="sm"
                    />

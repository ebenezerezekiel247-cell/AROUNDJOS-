...
import { ShieldCheck, ThumbsUp, Flag, MessageSquare, ChevronDown } from 'lucide-react';
import { StarRating, Button, Textarea, Badge, EmptyState } from '@/components/ui';
...
export function ReviewSection({ listingId, initialReviews, listingName }: ReviewSectionProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const id = await createReview(listingId, user.id, { rating, body });

...
export const CATEGORIES: Category[] = [
  {
    id: 'hotels-lodges', name: 'Hotels & Lodges', slug: 'hotels-lodges',
    description: 'Find the best hotels, guesthouses, and lodges in Jos',
    icon: 'Building2', color: '#FF7D0A', featured: true, order: 1,
    subcategories: [
  ...
  },
  {
    ...
    icon: 'UtensilsCrossed', color: '#EF4444', featured: true, order: 2,
    subcategories: [
  ...
  {
    id: 'lounges-nightlife', name: 'Lounges & Nightlife', slug: 'lounges-nightlife',
    description: 'Relaxation spots, clubs, and entertainment venues',
    icon: 'Wine', color: '#8B5CF6', featured: true, order: 3,
    subcategories: [
  ...
  {
    id: 'shortlets-apartments', name: 'Shortlets & Apartments', slug: 'shortlets-apartments',
    description: 'Short-term rentals and furnished apartments',
    icon: 'Home', color: '#10B981', featured: true, order: 4,
    subcategories: [
  ...
  {
    id: 'phones-gadgets', name: 'Phones & Gadgets', slug: 'phones-gadgets',
    description: 'Phone stores, repair shops, and gadget dealers',
    icon: 'Smartphone', color: '#3B82F6', featured: true, order: 5,
    subcategories: [
  ...
  {
    id: 'fashion-clothing', name: 'Fashion & Clothing', slug: 'fashion-clothing',
    description: 'Boutiques, tailors, and fashion stores',
    icon: 'ShoppingBag', color: '#F59E0B', featured: true, order: 6,
    subcategories: [
  ...
  },
  {
    ...
    icon: 'Sparkles', color: '#EC4899', featured: true, order: 7,
    subcategories: [
  ...
  {
    id: 'health-medical', name: 'Health & Medical', slug: 'health-medical',
    description: 'Hospitals, clinics, pharmacies, and labs',
    icon: 'HeartPulse', color: '#14B8A6', featured: false, order: 8,
    subcategories: [
  ...
  },
  {
    ...
    icon: 'Car', color: '#64748B', featured: false, order: 9,
    subcategories: [
  ...
  {
    id: 'events-tourism', name: 'Events & Tourism', slug: 'events-tourism',
    description: 'Event centers, photographers, and tourist attractions',
    icon: 'Camera', color: '#F97316', featured: false, order: 10,
    subcategories: [
  ...
  {
    id: 'local-services', name: 'Local Services', slug: 'local-services',
    description: 'Plumbers, electricians, lawyers, and more',
    icon: 'Wrench', color: '#6B7280', featured: false, order: 11,
    subcategories: [
